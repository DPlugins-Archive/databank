 ...
 */
final class Version20220219000424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billing (id INT NOT NULL, plan_id INT DEFAULT NULL, person_id INT NOT NULL, credit DOUBLE PRECISION DEFAULT \'0\' NOT NULL, is_active BOOLEAN DEFAULT false NOT NULL, is_auto_renewal BOOLEAN DEFAULT false NOT NULL, expired_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_EC224CAAE899029B ON billing (plan_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EC224CAA217BBB47 ON billing (person_id)');
        ...
        $this->addSql('CREATE TABLE person (id INT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE billing ADD CONSTRAINT FK_EC224CAA217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billing DROP CONSTRAINT FK_EC224CAA217BBB47');
